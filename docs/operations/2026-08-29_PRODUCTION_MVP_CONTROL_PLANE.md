...
| Automatic collector hardening | Windows `Task Scheduler` 通过 SSH tunnel 连接 QQG loopback Control Plane；protected runtime secret 修正后连续两个 interval 均为 3/3 Nodes ingest、`failed=0`，Task 保持 `Running` |
